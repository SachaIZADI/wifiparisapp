...
Viz3_plot <- function(start, end, duration_min=0, duration_max=7200, districts=c("All"), cat_sites=c("All"), sites=c("All"), countries=c("All"), devices=c("All"), analysis_axis = "None", hierarchy_view){

# filtering the data using Viz1_Filter function and calculating nb of connexion using
# number of connexion function. 
  
  data_Viz3_plot <- Viz1_Filter(start, end, duration_min, duration_max, districts, cat_sites, sites, countries, devices) %>%
